...
def create_date():
    date = [["small", "cyan", "irregular", "false"],
            ["big", "red", "irregular", "yes"],
            ["big", "red", "circle", "yes"],
            ["big", "cyan", "circle", "false"],
            ["big", "cyan", "irregular", "false"],
            ["small", "red", "circle", "yes"],
            ["big", "cyan", 'irregular', "false"],
            ["small", "red", "irregular", "false"],
            ["small", "cyan", "circle", "false"],
            ["big", "red", "circle", "yes"]
            ]
    lable = ["size", "color", "shape", "state"]
